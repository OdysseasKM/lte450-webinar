const WEBINAR_DATA = {
    ...
    sections: [
        ...
        { id: "appendix", name: "Appendix", slides: [37, 38, 39, 40, 41, 42, 43], icon: "file-text" }
    ],
    slides: [
        ...
        { num: 25, title: "Business Models and Funding", duration: 42, section: "Business and Planning" },
        { num: 26, title: "Deployment Roadmap Essentials", duration: 48, section: "Business and Planning" },
    ...
    transcripts: {
        ...
        8: "Successful LTE450 deployment starts with proper spectrum planning. Licensed spectrum is essential because it guarantees interference-free operation, which is a hard requirement for safety-critical services. As the frequency allocation chart illustrates, spectrum management is complex, but the 450 Alliance works with regulators to harmonise allocations across regions. This harmonisation simplifies equipment sourcing and reduces costs. Shared licensing models are also emerging in some markets, enabling multiple agencies to share the same spectrum band efficiently.",
        ...
        35: "Now is the time to start planning. We encourage you to assess spectrum availability and coverage gaps in your region, engage local agencies and potential partner organisations, connect with 450 Alliance partners to explore pilot opportunities, and begin planning your funding and procurement strategy. The technology is proven, the ecosystem is mature, and real-world deployments are delivering measurable results today.",
